...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_16361 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_16361(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_16362 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_16362(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_16363 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_16363(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_16364 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_16364(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_16365 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_16365(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_16366 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_16366(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__16359,callback){
var map__16360 = p__16359;
var map__16360__$1 = cljs.core.__destructure_map(map__16360);
var input = map__16360__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16360__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16360__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
