...
var i_11515 = (self__.level + (1));
while(true){
if((i_11515 <= (new_level + (1)))){
(update[i_11515] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_11517 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_11517[i]));
} else {
x__$2.forward.push((((i < links_11517.length))?(links_11517[i]):null));
}

if((i < links_11517.length)){
(links_11517[i] = x__$2);
} else {
links_11517.push(x__$2);
}
...
var i_11529 = (0);
while(true){
if((i_11529 <= self__.level)){
var links_11530 = (update[i_11529]).forward;
if((x__$1 === (((i_11529 < links_11530.length))?(links_11530[i_11529]):null))){
(links_11530[i_11529] = (x__$1.forward[i_11529]));

var G__11531 = (i_11529 + (1));
i_11529 = G__11531;
continue;
} else {
var G__11534 = (i_11529 + (1));
i_11529 = G__11534;
continue;
}
} else {
...
var G__11541 = nx;
var G__11542 = (level__$1 - (1));
x = G__11541;
level__$1 = G__11542;
continue;
} else {
var G__11543 = x;
var G__11544 = (level__$1 - (1));
x = G__11543;
level__$1 = G__11544;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__11554 = nx;
var G__11555 = (level__$1 - (1));
x = G__11554;
level__$1 = G__11555;
continue;
} else {
var G__11556 = x;
var G__11557 = (level__$1 - (1));
x = G__11556;
level__$1 = G__11557;
continue;
}
