...
var G__19821 = request;
var G__19822 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__19821,G__19822) : ajax.formats.get_format.call(null,G__19821,G__19822));
} else {
...
return cljs.core.some((function (p1__19823_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__19823_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__19824){
var map__19825 = p__19824;
var map__19825__$1 = cljs.core.__destructure_map(map__19825);
var request = map__19825__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19825__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__19826 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__19826.cljs$core$IFn$_invoke$arity$1 ? fexpr__19826.cljs$core$IFn$_invoke$arity$1(response) : fexpr__19826.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__19828){
var map__19829 = p__19828;
var map__19829__$1 = cljs.core.__destructure_map(map__19829);
var request = map__19829__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19829__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__19827_SHARP_){
return ajax.formats.get_accept_entries(request,p1__19827_SHARP_);
